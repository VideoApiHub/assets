...
export const minute01Defaults: FacelessAutomationProps = {
  ...facelessDefaults,
...
const WealthMinute01: React.FC<Partial<FacelessAutomationProps>> = (props) => {
  return <FacelessAutomation {...minute01Defaults} {...props} />;
};

export default WealthMinute01;